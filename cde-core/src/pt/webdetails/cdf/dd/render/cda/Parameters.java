...
public class Parameters implements CdaElementRenderer {
	...
	private final String NAME_ATTR = "name", DEFAULT_ATTR = "default",
			TYPE_ATTR = "type", ACCESS_ATTR = "access",
